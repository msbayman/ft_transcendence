    ...
    <div className="bg-custom-bg bg-cover bg-center h-screen w-full">
      <div className="relative flex justify-center top-[90px] ">
        ...
        <img
          ...
          alt="baorde"
          className={
            isPaused || Ballscore.l == 3 || Ballscore.r == 3
        ...
        <div className="absolute">
          <div className="relative w-[510px] h-[740px] mx-auto top-[120px]">
            ...
            <div
              className={
                isPaused
                  ? "relative top-[340px] left-[155px] text-white font-luckiest text-6xl"
                  : "hidden"
              }
            >
              PAUSED
            ...
            <div
              className={
                Ballscore.l == 3
                  ? "relative top-[340px] left-[50px] text-white font-luckiest text-6xl"
                  : "hidden"
              }
            >
              PALYER 1 IS WIN

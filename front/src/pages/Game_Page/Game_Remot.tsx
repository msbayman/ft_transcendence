    ...
    <>
      <div className="bg-[url('/background.png')] bg-cover bg-center h-screen w-full">
        <div className="relative flex justify-center top-[90px]">
          ...
          <img
            src={
              selectedIds?.board !== undefined
                ? SLIDEBOARDS[selectedIds.board]?.mapPath
                : SLIDEBOARDS[0].mapPath
            }
            alt={
              selectedIds?.board !== undefined
                ? SLIDEBOARDS[selectedIds.board]?.mapName
                : SLIDEBOARDS[0].mapName
            }
            className={
              gameState.winner
                ? "absolute mx-auto top-[120px] blur-sm"
                : "absolute mx-auto top-[120px]"
            }
          />
          ...
          <div className="absolute">
            <div
              className={
                gameState.winner
                  ? "relative top-[455px] text-center text-white font-luckiest text-6xl"
                  : "hidden"
              }
            >
              {gameState.winner === mydata.playerData?.username
                ? "You win!"
                : "You lose!"}
            </div>
            <div className="relative w-[510px] h-[740px] mx-auto top-[120px]">
              ...
              <div
                className={
                  gameState.winner
                    ? "hidden"
                    : "absolute w-[140px] h-[10px] top-[20px] transition-left duration-100 rounded-lg ease-linear"
                }
                style={{
                  left: `${gameState.paddles.left}px`,
                  backgroundColor: !selectedIds
                    ? SLIDECUES[0].mapPath
                    : SLIDECUES[selectedIds.paddel].mapPath,
                }}
              ></div>
              ...
              <div
                className={
                  gameState.winner
                    ? "hidden"
                    : "absolute w-[140px] h-[10px] transition-left bottom-[20px] duration-100 rounded-lg ease-linear"
                }
                style={{
              ...
              <div
                ...
                style={{
                  ...
                  backgroundColor: !selectedIds
                    ? SLIDEBALLS[0].mapPath
                    : SLIDEBALLS[selectedIds.ball].mapName,
                }}
              ></div>
            </div>
          </div>

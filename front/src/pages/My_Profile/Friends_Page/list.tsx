      ...
      try {
        const response = await fetch("https://localhost:8000/chat/api/users/", {
          headers: {
            Authorization:
              "Bearer " +
              "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzM0NjM0NDcyLCJpYXQiOjE3MzQzNzUyNzIsImp0aSI6IjE4ODRhYTQ3MjlkZjQ2NWJiYTAyNDBmNTU3NzVjZTdhIiwidXNlcl9pZCI6MTN9.sPEv0q4AMl80_TW73rSBNp7m2QgDTtWi2NWsBwX6DcA",
          },
        });
        if (response.ok) {

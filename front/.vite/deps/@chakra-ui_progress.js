...
var Circle = (props) => (0, import_jsx_runtime4.jsx)(chakra.circle, { cx: 50, cy: 50, r: 42, fill: "transparent", ...props });
...
var CircularProgress = forwardRef(
  (props, ref) => {
    ...
    const determinant = isIndeterminate ? void 0 : ((_a7 = progress2.percent) != null ? _a7 : 0) * 2.64;
    ...
    return (0, import_jsx_runtime6.jsxs)(
      chakra.div,
      {
        ...
        __css: rootStyles,
        children: [
          (0, import_jsx_runtime6.jsxs)(Shape, { size: size2, isIndeterminate, children: [
...
function createContext3(options = {}) {
  ...
  const Context = (0, import_react14.createContext)(defaultValue);
  Context.displayName = name;
  function useContext3() {
    var _a7;
...
var [ProgressStylesProvider, useProgressStyles] = createContext3({
...
var Progress = forwardRef((props, ref) => {
  ...
  const borderRadius = propBorderRadius != null ? propBorderRadius : (_a7 = styles2.track) == null ? void 0 : _a7.borderRadius;
  ...
  return (0, import_jsx_runtime7.jsx)(
    chakra.div,
    {
      ...
      __css: trackStyles,
      ...rest,
      children: (0, import_jsx_runtime7.jsxs)(ProgressStylesProvider, { value: styles2, children: [
...
var ProgressLabel = (props) => {
  ...
  return (0, import_jsx_runtime8.jsx)(chakra.div, { ...props, __css: labelStyles });
};
...
//# sourceMappingURL=@chakra-ui_progress.js.map
